...
-- Таблица товаров в корзине с проверками
...
CREATE INDEX IF NOT EXISTS idx_carts_username ON shopping_cart.carts(username);
CREATE INDEX IF NOT EXISTS idx_cart_products_cart ON shopping_cart.cart_products(cart_id);